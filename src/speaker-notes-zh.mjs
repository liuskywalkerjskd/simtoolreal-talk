...
`大家好，今天汇报的工作是 SimToolReal。它关心的不是如何为一把特定的锤子训练一套动作，而是一个更一般的问题：如果我们只告诉机器人“工具应该怎样运动”，能不能让同一个灵巧操作策略自己决定手臂和手指应该怎样配合？
...
'封面停留片刻，先强调 reusable controller 与 tool motion 这两个关键词。'),
...
note('LSTM memory carries interaction history across steps','LSTM 用历史信息补足部分可观测性','约 120 秒',
